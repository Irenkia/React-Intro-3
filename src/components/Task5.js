...
const Task5 = function () {
    ...
    const show = (oldArrTask5, newArrTask5) => {
...
//     },
// ];
// class ToyotaTask5 extends Component {
//     //data = ArrTask4;
//     constructor(props) {
//         super(props);
//         this.state = {
...
//     console.log(Object.keys(ArrTask5));
...
//     const AddNewArrTask4 = { ...ArrTask5, id: 9, year: 2021, name: "9 поколение" };
